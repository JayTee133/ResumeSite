...
class SiteContentsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('site_contents')->insert([
        	'name' => 'Moving Forward',
        	'page' => 'aboutsite',
        	'content' => "I'd like the site to look a little nicer. I need to put more time into learning about design concepts and tools. ",
        ]);
